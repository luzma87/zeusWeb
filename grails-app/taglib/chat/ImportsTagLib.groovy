...
//    static encodeAsForTags = [tagName: 'raw']
    ...
    def favicon = { attrs ->
        ...
        favicons += "<link rel='apple-touch-icon' sizes='72x72' href='${resource(dir: 'images/favicons', file: 'apple-touch-icon-76x76.png')}'>"
        ...
        favicons += "<link rel='icon' type='image/png' href='${resource(dir: 'images/favicons', file: 'favicon-194x194.png')}' sizes='194x194'>"
        favicons += "<link rel='icon' type='image/png' href='${resource(dir: 'images/favicons', file: 'favicon-96x96.png')}' sizes='96x96'>"
        favicons += "<link rel='icon' type='image/png' href='${resource(dir: 'images/favicons', file: 'android-chrome-192x192.png')}' sizes='192x192'>"
        favicons += "<link rel='icon' type='image/png' href='${resource(dir: 'images/favicons', file: 'favicon-16x16.png')}' sizes='16x16'>"
        favicons += "<link rel='manifest' href='${resource(dir: 'images/favicons', file: 'manifest.json')}'>"
        favicons += "<meta name='msapplication-TileColor' content='#2d89ef'>"
    ...
    def importCss = { attrs ->
        ...
        // Flaticons pins
        text += imp.css(src: resource(dir: 'fonts/flaticons-pins', file: 'flaticon.css'))
        // FontAwesome
