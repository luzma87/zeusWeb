    ...
    <body>
        ...
        <script type="text/javascript">
            ...
            function infoMensaje() {
                ...
                $.ajax({
                    type    : "POST",
                    url     : "${g.createLink(controller: 'chatPolicia',action: 'getInfoMensaje_ajax')}",
...
//                console.log($mensajes.scrollTop(), $mensajes[0].scrollHeight, scroll)
                $.ajax({
                    type     : "POST",
                    url      : "${g.createLink(controller: 'chatPolicia',action: 'getMessages_ajax')}",
                    data     : "actual=" + actual,
                    dataType : "json",
                    success  : function (msg) {
                        var data = msg;
            ...
            $("#enviar").click(function () {
                ...
                if ($.trim(texto) != "") {
                    $.ajax({
                        type    : "POST",
                        url     : "${g.createLink(controller: 'chatPolicia',action: 'enviarMensaje_ajax')}",
